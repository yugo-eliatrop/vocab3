...
export interface ApiAusdruckAusdruck extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    negativeCount: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    text: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    uebersetzungs: Schema.Attribute.Relation<
      'manyToMany',
      'api::uebersetzung.uebersetzung'
    >;
...
export interface ApiUebersetzungUebersetzung
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    text: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    ausdrucks: Schema.Attribute.Relation<
      'manyToMany',
      'api::ausdruck.ausdruck'
    >;
    comment: Schema.Attribute.RichText;
    wortfamilies: Schema.Attribute.Relation<
      'manyToMany',
      'api::wortfamilie.wortfamilie'
    >;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiWortfamilieWortfamilie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    adjective: Schema.Attribute.String;
    points: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ausdruck.ausdruck': ApiAusdruckAusdruck;
      'api::theme.theme': ApiThemeTheme;
      'api::uebersetzung.uebersetzung': ApiUebersetzungUebersetzung;
      'api::wortfamilie.wortfamilie': ApiWortfamilieWortfamilie;
